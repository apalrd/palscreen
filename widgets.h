...
void widget_draw_thermo_v(int x1, int x2, int y1, int y2, float fill_level, uint16_t color_ft, uint16_t color_bg);
void widget_draw_thermo_h(int x1, int x2, int y1, int y2, float fill_level, uint16_t color_ft, uint16_t color_bg);
